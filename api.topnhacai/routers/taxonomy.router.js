 ...
 *
 */
router.get(`/taxonomy/descendants/:tax_id`, descendants); //hiển thị các con của danh mục cha
router.get(`/taxonomy/tax/search`, search);
/**
 * @swagger
 * /api/taxonomy:
 *   post:
...
router.post(
  `/taxonomy/`,
  authorize(permissionFunction.TAXONOMY, permissionFieldName.ADD),
  create
);
...
router.put(
  "/taxonomy/:id",
  authorize(permissionFunction.TAXONOMY, permissionFieldName.EDIT),
  updateTaxonomy
);
...
router.delete(
  `/taxonomy/remove/:id`,
  authorize(permissionFunction.TAXONOMY, permissionFieldName.DELETE),
  remove
);
/**
 * @swagger
 ...
 */
router.delete(
  `/taxonomy/removeTax/:id`,
  authorize(permissionFunction.TAXONOMY, permissionFieldName.DELETE),
  removeTax
); //Xoá danh mục (xoá các danh mục con cháu của nó)

router.get("/taxonomy/getByType/:type", getByType);
