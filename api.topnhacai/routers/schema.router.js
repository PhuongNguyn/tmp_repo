 ...
 *        $ref: '#/components/responses/NotFoundError'
 */
router.get('/schemas/schema/search', search);
 ...
 *        $ref: '#/components/responses/NotFoundError'
 */
 router.post('/schemas/', authorize(permissionFunction.SCHEMA, permissionFieldName.ADD), create)
 ...
 *        $ref: '#/components/responses/NotFoundError'
 */
 router.put('/schemas/:id', authorize(permissionFunction.SCHEMA, permissionFieldName.EDIT), edit)
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/NotFoundError'
 */
 router.delete('/schemas/remove/:id', authorize(permissionFunction.SCHEMA, permissionFieldName.DELETE), remove);
