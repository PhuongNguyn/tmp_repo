 ...
 *        $ref: '#/components/responses/NotFoundError'
 */
router.get("/pages/page/search", search);

router.get("/pages/getBySlug/:slug", getBySlug);
...
router.post(
  "/pages/",
  authorize(permissionFunction.PAGE, permissionFieldName.ADD),
  create
);
...
router.put(
  "/pages/:id",
  authorize(permissionFunction.PAGE, permissionFieldName.EDIT),
  edit
);
...
router.delete(
  "/pages/remove/:id",
  authorize(permissionFunction.PAGE, permissionFieldName.DELETE),
  remove
);
