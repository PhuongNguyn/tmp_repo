...
const BannersList = () => {
  ...
  const handlePermission = async () => {
    let userPermission = permission.find((item) => item.name === "banner");
      ...
      removeBanner(record._id)
        .then((res) => {
          notification["success"]({
            ...
            description: "Delete link sucessfully!",
          });
          getListBanner();
        })
        .catch((error) => {
  ...
  const editBanner = () => {
    updateBanner(bannerSelected._id, formVal)
      .then((res) => {
                ...
                <div className="table-responsive mt-4 mt-xl-0">
                  ...
                  >
                    ...
                    <Column
                      ...
                      dataIndex="position"
                      key="position"
                      render={(position) => convertPosition(position)}
                    />
                    <Column
                      width="10%"
                      title="Trang"
                        ...
                        <Space size="middle">
                          {isPermission["edit"] && (
                            <i
                              ...
                              onClick={() => openPopupEditBanner(val)}
                            ></i>
                          )}
                          {isPermission["delete"] && (
                            <Popconfirm
