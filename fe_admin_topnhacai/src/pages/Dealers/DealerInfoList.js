...
function DealerInfoList() {
  ...
  const handlePermission = async () => {
    let userPermission = permission.find((item) => item.name === "dealerInfor");
          ...
          <Row>
            <Col lg={12}>
              ...
              >
                ...
                />
                <Column title="Tên " dataIndex="di_name" key="di_name" />
                {/* <Column title="Chủ quản" dataIndex="di_host" key="di_host" /> */}
                <Column
                  title="Trụ sở chính"
                  dataIndex="di_headquarters"
                  key="di_headquarters"
                />
                <Column
                  title="Giấy phép"
                  dataIndex="di_license"
                  key="di_license"
                />
                <Column
                  title="Năm thành lập"
                  dataIndex="di_founded_year"
                  key="di_founded_year"
                />
                ...
                <Column
                  ...
                  render={(val, record) => (
                    <Space size="middle">
                      {isPermission["edit"] && (
                        <>
                          <Link to={{ pathname: "/dealers-info/" + val._id }}>
                            <i className="ri-eye-line action-icon"></i>
                          </Link>
                          <Link
                            to={{ pathname: "/dealers-info/edit/" + val._id }}
                          >
