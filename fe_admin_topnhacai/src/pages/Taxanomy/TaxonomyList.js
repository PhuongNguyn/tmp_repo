...
function TaxonomyList() {
  ...
  const handlePermission = async () => {
    let userPermission = permission.find((item) => item.name === "taxonomy");
          ...
          <Row>
            <Col lg={12}>
              <Table rowKey="_id" dataSource={taxonomies}>
                ...
                />
                <Column title="Tên" dataIndex="tax_name" key="tax_name" />
                <Column
                  title="Mô tả"
