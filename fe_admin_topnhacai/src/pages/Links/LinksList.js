...
const LinksList = () => {
  ...
  const handlePermission = async () => {
    let userPermission = permission.find((item) => item.name === "linkFooter");
  ...
  const editLink = () => {
    updateLink(linkSelected._id, formVal)
      .then((res) => {
        setAddLinkModalVisible(false);
        setLinkSelected(null);
        getListLink();
