const getResultsEveryMinute = (res) => {
  let companyList = [
    { id: 3, name: "Crown" },
    { id: 4, name: "Ladbrokes" },
    { id: 1, name: "Macauslot" },
            ...
            let newHandicap =
              item1.split(",").length > 0
                ? {
                    ...
                    handicapIndex: item1.split(",")[10],
                    handicapCount: item1.split(",")[11],
                    changeTime: item1.split(",")[12],
                    close: item1.split(",")[13],
                  }
                : [];
            return newHandicap;
          }
            ...
            let newEuropeOdds =
              item1.split(",").length > 0
                ? {
                    ...
                    instantAway: item1.split(",")[7],
                    handicapIndex: item1.split(",")[8],
                    changeTime: item1.split(",")[9],
                    close: item1.split(",")[10],
                  }
                : [];
            ...
            let newHandicap =
              item1.split(",").length > 0
                ? {
                    ...
                    instantHome: item1.split(",")[6],
                    instantAway: item1.split(",")[7],
                    inPlay: item1.split(",")[8],
                    handicapIndex: item1.split(",")[9],
...
export default getResultsEveryMinute;
