...
router.get('/getMenuChildrenBySlug/:slug', menuController.getMenuChildrenBySlug);
router.get('/getMenuByParent/:slug', menuController.getMenuByParent);
router.get('/getAllMenuChildrenBySlug/:slug', menuController.getAllMenuChildrenBySlug);
