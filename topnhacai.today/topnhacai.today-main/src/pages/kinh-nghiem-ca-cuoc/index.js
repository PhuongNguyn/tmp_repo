...
const BeautifulGirlPage = ({ pageData, dataImage, postData , postData1, postTopViews }) => {
  ...
  if(pageData){
    ...
    /* breadTitle = pageData.tax_name;
    Tax = {
        taxTitle: pageData.tax_name,
        taxDescription: pageData.tax_description,
    }; */
  ...
  return (
    <>
     <Head>
        <title>Top nhà cái - Kinh nghiệm cá cược</title>
...
export const getServerSideProps = async () => {
  const Slug = "kinh-nghiem-ca-cuoc";
  const taxId = "62cbe11886cf76fe1caf7d27";
