...
//     skip: 0,
//   };
//   var mybutton = document.getElementById("btnArraw");
...
//   //     document.getElementById("btnArraw").style.display = "block";
//   //   } else {
//   //     document.getElementById("btnArraw").style.display = "none";
//   //   }
//   // }
...
//     <>
//      <Head>
//         <title>Top nhà cái - Trang chủ</title>
//         <link rel="icon" href="/favicon.ico" />
//         <script type="application/ld+json" id="home" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaData) }}>
//         </script>
//       </Head>
//       <Menu />
//       <TopHeader />
...
//             </div>
//             <div className="row">
//               <div className="col span_9 bxcontainer">{<Home data={props}/>}</div>
...
//             <Image src="https://topnhacai.b-cdn.net/icon-arrow.png" width={25} height={16} alt="" />
//           </button>
//         </div>
//         <Footer />
//       </div>
